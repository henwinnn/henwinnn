...
- 💼 Front-End Developer at **PT Balangga Prakoso Teknologi** — building and maintaining internal web apps with **React.js, Next.js & TypeScript**
- 🏆 **3rd Place — Lisk Chain Hackathon 2025** with [NusanSwap](https://nusanswap.vercel.app/), a decentralized exchange prototype (covered by Metro TV News)
- 🌱 Currently learning **AI engineering** — building RAG pipelines with **LangChain** & **LangGraph**
- ⛓️ Exploring **Web3 frontend**: DEXs, cross-chain apps, and wallet integrations
